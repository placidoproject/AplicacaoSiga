...
public class listaProdutosPorCaixa extends Activity implements SearchView.OnQueryTextListener{
            ...
            case 2:
                MensagemUtil.addMsgConfirm(this, "Alerta", "Deseja realmente excluir o Produto selecionado", R.drawable.delete, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        MensagemUtil.addMsg(listaProdutosPorCaixa.this, "Produto excluida com sucesso");
                        Intent i = new Intent(listaProdutosPorCaixa.this, listaProdutosPorCaixa.class);
                        startActivity(i);
                        finish();
    ...
    private void consultarPorId() {
        lstProdutos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapter, View view, int id, long position) {
                ...
                MensagemUtil.addMsgOk(listaProdutosPorCaixa.this, "Info", msg, R.drawable.ic_launcher);
